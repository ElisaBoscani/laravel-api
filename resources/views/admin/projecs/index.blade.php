                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex flex-column gap-3">
                                <a href="{{ route('admin.projects.show', $projec->id) }}"
                                    class="btn btn-outline-warning btn-sm">Show</a>
                                <a href="{{ route('admin.projects.edit', $projec->id) }}"
                                    class="btn btn-outline-info btn-sm">Edit</a>

                                <button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#modalId-{{ $projec->id }}">
                                    Delete
                                </button>
                                <div class="modal fade" id="modalId-{{ $projec->id }}" tabindex="-1" role="dialog"
                                    aria-labelledby="modalTitle-{{ $projec->id }}" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="modalTitle-{{ $projec->id }}">Confirm
                                                    Deletion</h5>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form method="POST"
                                                    action="{{ route('admin.projects.destroy', $projec->id) }}">
                                                    @csrf
                                                    @method('DELETE')
